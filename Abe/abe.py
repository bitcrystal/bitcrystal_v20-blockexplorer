...
<body>
    <h1><a href=\"%(dotdot)s%(HOMEPAGE)s\"><img
     src=\"%(dotdot)s%(STATIC_PATH)slogo32.png\" class=\"logoimg\" style=\"vertical-align: middle;\" alt=\"Bitcrystal logo\" /></a> %(h1)s
    </h1>
    %(body)s
    <p style=\"font-size: smaller\">
        <span style=\"font-style: italic\">
            Bitcrystal Explorer powered by <a href=\"%(ABE_URL)s\">%(APPNAME)s</a>
        </span><br />
        Tips appreciated!
        <a href=\"%(dotdot)saddress/%(DONATIONS_BTC)s\">BTC</a>
        <a href=\"%(dotdot)saddress/%(DONATIONS_NMC)s\">BTCRY</a>
    </p>
    <p style=\"font-size: smaller\">
